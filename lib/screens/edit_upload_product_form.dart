  ...
  Future<void> _uploadProduct() async {
    ...
    try {
      ...
      final querySnapshot = await FirebaseFirestore.instance
          .collection("products")
          .where("productTitle", isEqualTo: _titleController.text.trim())
          .where("productPrice", isEqualTo: _priceController.text.trim())
          .where(
            "productCategory",
            isEqualTo: _categoryValue ?? "Uncategorized",
          )
          .where(
            "productDescription",
            isEqualTo: _descriptionController.text.trim(),
          )
          .get();
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        MyAppFunctions.showErrorOrWarningDialog(
          context: context,
          subtitle: "This product already exists in the database!",
          fct: () {},
        );
        return;
      }
